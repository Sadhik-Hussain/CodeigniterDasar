          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" name="alamat" required="required" id="cont" placeholder="To:">
              </div>
              <div class="form-group">
                <input class="form-control" name="judul" required="required" placeholder="Subject:">
              </div>
              <div class="form-group">
